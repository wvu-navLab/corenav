...
% hold on
% plot(tTimu(1:end-1,1)-tTimu(1),ENU3P(2,:),'--k')
% hold on
% plot(tTimu(1:end-1,1)-tTimu(1),ENU_3P(2,:),'--k')
ylabel('N (m)')
xlabel('time (sec)')
legend('show');
...
% hold on
% plot(tTimu(1:end-1,1)-tTimu(1),ENU3P(3,:),'--k')
% hold on
% plot(tTimu(1:end-1,1)-tTimu(1),ENU_3P(3,:),'--k')
ylabel('U (m)')
xlabel('time (sec)')
legend('show');

% h(3)=figure;
% plot(tTimu(1:end-1,1)-tTimu(1),ENU(1,:),'-.b','DisplayName','LLN'); 
% hold on;
% plot(tTodom-min(tTodom),ENUGPS(1,1:length(tTodom)),'-.r','DisplayName','true')
% % hold on;
% % plot(tTodom-min(tTodom),Pos_x-Pos_x(1),'-.g','DisplayName','odom')
% hold on
% plot(tTimu(1:end-1,1)-tTimu(1),ENU3P(1,:),'--k')
% hold on
% plot(tTimu(1:end-1,1)-tTimu(1),ENU_3P(1,:),'--k')
% ylabel('E (m)')
% xlabel('time (sec)')
% legend('show');
% 
...
ylabel('x (m)')
xlabel('time (sec)')
subplot(312),plot(tTimu(1:end-1,1)-tTimu(1),gpsLongerXYZ(2,:)-xyz(2,:),'DisplayName','y_{err}')
ylabel('y (m)')
xlabel('time (sec)')
...
for ii=1:1500:length(ENU(1:100000)) 
